...
def my_norm(a, coord):
    """Normalizes a given value within [0,1] or [-1,1]"""
...
if __name__ == "__main__":
    ...
    for i, (left, right) in enumerate(splitted_data):
        ...
        path_left = (
            f"data/split_{'00' if i < 10 else '0' if i < 100 else ''}{i}_left.pt"
        )
        path_right = (
            f"data/split_{'00' if i < 10 else '0' if i < 100 else ''}{i}_right.pt"
        )
